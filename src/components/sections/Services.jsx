  ...
  return (
    <section>
      ...
      <div className="flex flex-col items-start justify-center w-full">
        {/* Headings */}
        <div
          className="flex flex-col items-start justify-center w-full px-[1.9rem] lg:px-[3rem] py-[3rem] gap-[1rem]"
          data-aos="zoom-in-up"
        ...
        <section>
          ...
          >
            {/* content and button */}
            <div
              className="flex text-wrap flex-col text-center items-center justify-center w-full px-[3rem] py-[4rem] gap-[1rem]"
              data-aos="zoom-in-up"
              data-aos-duration="1000"
            >
