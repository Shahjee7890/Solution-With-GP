      ...
      >
        {PortfolioTeam.map((curData, index) => {
          ...
          return (
            ...
            >
              <div
                className="flex flex-wrap text-wrap flex-col items-center justify-center gap-3 py-[2rem] text-white"
                data-aos="zoom-in-up"
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center gap-2">
                  <h3 className="text-[20px] text-white font-[700] font-raleway">
                    {name}
                  </h3>
                  {/* title */}
                ...
                <div className="flex items-center gap-2">
                  {rating?.map(() => (
                    <div className="text-[#ffc108]">
                      {TiStarFullOut["TiStarFullOutline"]}{" "}
                    </div>
                  ))}
                </div>
                {/* discrption */}
                <div className="w-[60%] text-center">
                  ...
                  <span className="text-[18px] font-[500] text-center font-roboto">
                    <i>{discrption}</i>
                  </span>
                  <i class="bi bi-quote"></i>
                </div>
